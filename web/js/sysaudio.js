...
// один движок — ни WebKit, ни Chrome. Трансляция уходит немой, и закрыть эту
// дыру может только оболочка (`sysaudio.rs`): она снимает звук через
// ScreenCaptureKit и присылает сюда отсчёты.
//
 ...
 * молчания приходит ровно пять секунд нулевых отсчётов. Значит ноль байт
 * означает не «нечего транслировать», а «захват не работает», и об этом можно
 * честно сказать человеку, не заставляя его гадать.
 */
