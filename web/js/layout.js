...
/**
 * Телефон в вертикали — единственная раскладка, где всё лежит сверху вниз.
 *
 * Панель здесь ложится снизу, а не сбоку: тянуть её надо вверх, а не вбок.
 * Стоит телефон повернуть — и раскладка становится маленьким настольным, где
 * панель стоит сбоку и тянется вбок. Пока здесь стояла одна проверка ширины, в
 * горизонтали полоска меняла высоту панели, которая высоту и так занимала всю.
 *
 * Тем же вопросом заняты стили (`max-width: 860px and orientation: portrait`) и
 * список участников: строка там ужимается до ника, и настраивать собеседника
 * приходится карточкой. Условие поэтому одно на всех и живёт здесь.
 */
