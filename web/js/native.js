...
export const native = {
  ...
  caps: {
    ...
    background: false,
    // Может ли оболочка сама снять звук компьютера. Нужно там, где его не
    // отдаёт движок: macOS и Linux — см. sysaudio.js.
    systemAudio: false,
    // Попадают ли в этот звук голоса собеседников. На Linux попадают: монитор
    // устройства вывода — готовая смесь, и выкинуть из неё себя нечем.
    systemAudioMixesUs: false,
  },
