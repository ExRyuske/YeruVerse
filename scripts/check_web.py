...
# Процессор WebAudio (`*-worklet.js`) живёт не на странице, а в своём мире, и
# глобальные имена там другие. Проверять эти файлы всё равно стоит — опечатку
# в них не поймает вообще ничто, — поэтому просто добавляем недостающее.
BROWSER |= {"registerProcessor", "AudioWorkletProcessor", "sampleRate", "currentTime"}
